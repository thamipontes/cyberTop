 ...
 */
public class PrincipalExcluir extends javax.swing.JFrame {

    /**
     * Creates new form PrincipalFinal
     */
    public PrincipalExcluir() {
        initComponents();
    ...
    private void mnAjudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnAjudaActionPerformed
        try {
            ...
            Logger.getLogger(PrincipalExcluir.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalExcluir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalExcluir().setVisible(true);
            }
        });
    }
